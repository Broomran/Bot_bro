    ...
    for (const user in scores) {
        ...
        if (
            ...
            arr.push({
                ...
                score:
                data.rooms[room].score,

                best:
                data.rooms[room].bestSpeed
